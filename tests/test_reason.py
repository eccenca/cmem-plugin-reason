...
def test_reason(setup: None, reasoner_parameter: str) -> None:
    """Test reasoning"""
    ReasonPlugin(
...
def test_reason_ontology_import(setup: None) -> None:
...
def test_reason_ontology_import_2(setup: None) -> None:
